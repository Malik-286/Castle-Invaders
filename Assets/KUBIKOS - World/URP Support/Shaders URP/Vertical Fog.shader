	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float distanceDepth11 = ( screenDepth11 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Float0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _Color0.rgb;
				float Alpha = ( distanceDepth11 * _Float1 );
...
ASEEND*/
//CHKSM=BB46F6635E2A3D1CD46DAD13BC7BD26FFC14470C